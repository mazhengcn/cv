...
\usepackage{fontspec}
\setmainfont{TeX Gyre Pagella}[Ligatures=TeX, Numbers=Lining]   % Palatino-style, elegant humanist serif
\setsansfont{TeX Gyre Heros}[Scale=MatchLowercase, Ligatures=TeX]  % Helvetica-style for headings & visuals
\setmonofont{Inconsolatazi4}[Scale=0.88]                           % Clean monospace for URLs and code
...
\usepackage{xcolor}
\definecolor{accentcolor}{HTML}{1B3A6B} % Deep navy blue — prestigious academic tone
\definecolor{linkcolor}{HTML}{1565C0}   % Classic blue for links
\definecolor{sectionbg}{HTML}{EEF2F7}   % Light blue-tinted background
\definecolor{rulecolor}{HTML}{B0BEC5}   % Soft steel gray for decorative rules
...
\fancyhead[L]{\small\color{black!60}\textit{Research Statement \,---\, Zheng Ma}}
\fancyhead[R]{\small\color{black!60}\textit{April 2026}}

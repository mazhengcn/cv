...
The transition from specialized neural solvers to the overarching
``Agent of Real Physical Science'' paradigm requires overcoming several rigid
theoretical and scale-related bottlenecks. My ongoing and planned research
addresses these bottlenecks across three interconnected frontiers, each
combining fundamental mathematical questions with high-stakes engineering
applications. These directions extend the full-stack AI logic from the
foundational models developed to date toward next-generation plasma physics,
provable uncertainty quantification in inverse problems, and generalized
structure-preserving learning.

\subsection{Foundation Models for Plasma and Fusion Confinement}
...
\subsection{Convergence Theory for Generative Models in Inverse Problems}
...
\subsection{Structure-Preserving Operator Learning}

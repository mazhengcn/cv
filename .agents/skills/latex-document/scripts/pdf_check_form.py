...
def main():
    ...
    try:
        ...
        if has_fields:
            ...
            print(
                "Use pdf_extract_fields.py to extract field info, then pdf_fill_form.py to fill them."
            )
        else:
            print(
            ...
            print(
                "Use pdf_fill_annotations.py to add text annotations at specific positions."
            )
    except Exception as e:
